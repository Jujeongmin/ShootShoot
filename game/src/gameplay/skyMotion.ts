...
export function driftWrapped(x: number, dx: number, minX: number, maxX: number): number {
...
export function flightProgress(t: number, dt: number, durationSeconds: number): number {
